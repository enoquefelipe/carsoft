...
<html>
    ...
    <body>
        <c:import url="_headerConce.html"/>

        <div class="cadastro-colaborador">
            <form class="form-horizontal" action="adicionaInt" method="POST">

                <div class="form-group">
                    <label class="col-sm-2 control-label" for="nome"> Nome </label> 
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nome" name="pessoa.nome" placeholder="Nome" required=""/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" id="rg" name="pessoa.rg" placeholder="RG" required=""/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" id="cpf" name="pessoa.cpf" placeholder="CPF" required=""/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="date" class="form-control" id="nascimento" name="pessoa.nascimento" required=""/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="rua" name="endereco.lagradouro" placeholder="Avenida, Rua, Viela e etc" required="" >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="email" class="form-control" id="email" name="contato.email" placeholder="E-mail" required="">
                    </div>
                </div>
